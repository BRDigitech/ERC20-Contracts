/**
 *Submitted for verification at testnet.bscscan.com on 2021-11-23
*/
...
contract ShibaSanta is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000000 * 10**9; // 1,000,000,000,000,000,000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ShibaSanta";
    string private _symbol = "Shibax";
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        uint256 accountBalance = _rTotal;
        require(accountBalance >= amount, "BEP20: burn amount exceeds balance");
        _rTotal = accountBalance - amount;
        _tTotal -= amount;
