/**
 *Submitted for verification at testnet.bscscan.com on 2021-11-25
*/
...
contract MONEYSHOT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 696969696969 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MONEYSHOT";
    string private _symbol = "$HOT";
    ...
    address payable public devWallet = payable(0x787AAe22aeA1dCC22fb229d80Fda923508d0E891);
    ...
    uint256 public numTokensSellToAddToLiquidity = 696969696 * 10**18;
    uint256 public _maxTxAmount = 6969696969 * 10**18;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 combineFees = _liquidityFee.add(_devFee); // marketing + liquidity fees
        ...
        transferToAddressETH(devWallet, transferredBalance);
    }
    ...
    returns (uint256, uint256)
    {
        ...
        uint256 tMarketing = tAmount.div(100).mul(_devFee);
