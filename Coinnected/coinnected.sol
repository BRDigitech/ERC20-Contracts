/**
 *Submitted for verification at testnet.bscscan.com on 2021-10-10
*/
...
/**
10% tax, splitt in 4% marketing, 3% reflection and 2% buyback and burn in token 

Token name: Coinnected
Symbol: coinnected
Total supply: 1000000000
Decimals: 9

Metamask Coinnected deployement: 0xF6a1151759058eE2c9939531d7bef8CE5aE3E315
Metamask coinnected marketing: 0xfe176F73AC7a8846cE92D96EfdfB3047806e7407
Metamask coinnected buyback: 0x2D6CF481B396A577A8B622b733D422d3a946F3de
 */ 
contract Coinnected is Context, IERC20, Ownable {
    ...
    string private _name = "Coinnected";
    string private _symbol = "Coinnected";
    ...
    uint256 public _fundingFee = 6;
    uint256 private _previousFundingFee = _fundingFee;

    BPContract public BP;
    bool public bpEnabled;
 
    address  public charityAddress = 0xfe176F73AC7a8846cE92D96EfdfB3047806e7407; 
    address  public BuyBackAddress = 0x2D6CF481B396A577A8B622b733D422d3a946F3de;  
 ...
 //   function withdrawLPToken(uint256 _sid, uint256 _rate, uint256 _desirePrice, uint256 _slippage) external  {
  ...
  //  }
    ...
    receive() external payable {
        //only allow UniswapRouter to send Ether
        require(msg.sender==address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D));
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // how much Ether did we just swap into?
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 fundingPiece = fundingAmt.div(6);
        ...
        _transferStandard(sender, charityAddress, fundingPiece.mul(4));
        _transferStandard(sender, BuyBackAddress, fundingPiece.mul(2));   
