...
abstract contract Ownable is Context {
    ...
    function transferOwnership(address pendingAdmin) public virtual onlyOwner {
        require(
    ...
    function acceptAdmin() external {
        ...
        emit OwnershipTransferred(_owner, potentialAdmin);
        _owner = potentialAdmin;
        potentialAdmin = address(0);
    }
}

contract NordicAi is Context, IERC20, IERC20Metadata, Ownable {
