//https://sepolia.basescan.org/address/0x2636b95c86e8d004988082a7aeafbfcf85c1ab7d#code

/**
 *Submitted for verification at sepolia.basescan.org on 2024-03-30
*/
...
contract PPUMP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PPUMP", "PPUMP") {

        address newOwner = address(owner());
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xf6441bbbb55aaf15aaF4007b82202450858Da7c9);
    	...
    	marketingWallet = address(0x56aad984A1B063458bB4a6b57457bf2E2126850c); // set as marketing wallet
