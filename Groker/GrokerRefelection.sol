...
contract GrokReflections is Context, IERC20, Ownable {
    ...
    string constant private _name = "GrokR";
    string constant private _symbol = "GROKR";
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 totalTax = rFee.add(rLiquidity);
