/**
https://basescan.org/token/0xbf9e89BD70e7dBaA30d0faE636925b1A5d1C94F9#code
...
contract Sting is Context, Ownable, IERC20, ERC20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x0ba7fDc74deB71DC7F6150874B5236833112329a);
    ...
    constructor () ERC20Detailed("Crypto Wasps Ecosystem", "$STING", 9) {
      _owner = msg.sender ;
    _totalSupply = 200000000 * (10**9);
    
	_balances[_owner] = _totalSupply;
	//uniswapv3 router = 0xf6441bbbb55aaf15aaF4007b82202450858Da7c9
