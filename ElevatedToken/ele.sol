// https://etherscan.io/address/0x248319be74fa97938012a50a71a860e16efe79c9#code
/**
...
contract ElevatedToken  is Context, IERC20, IERC20Metadata, Ownable, Pausable{
    ...
    constructor () {
        _name = "Elevated Token";
        _symbol = "ELE";
        _totalSupply;
        _mint(owner(), 24000000 * 10 ** (decimals()) ); 
