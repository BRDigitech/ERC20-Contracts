...
contract DroneToken is Context, IERC20, Ownable {
    ...
    string private _name = "Drone";
    string private _symbol = "DRONE";
    ...
    uint256 public _fundingFee = 7;
    uint256 private _previousFundingFee = _fundingFee;
    
    address  public DevelopmentAddress = 0xd26c0866fC8C76F7e041e35bC610aa3D3AD5a90D; 
    address  public MarketingAddress = 0x7A80fc0a074Ee6925028b5628A5382d7aE01CfE9; 
    address  public MiningAddress = 0x70098E7DA6c8F8B0D05B5be6619AB6c6bf6eb21c;
    ...
    uint256 public _maxTxAmount = 5000000 * 10**9; // 0.5 % Buy and sell
 ...
 //   function withdrawLPToken(uint256 _sid, uint256 _rate, uint256 _desirePrice, uint256 _slippage) external  {
  ...
  //  }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 fundingPiece = fundingAmt.div(7);
        ...
        //Send transfers to burn Development and Marketing wallets
        // _transferStandard(sender, address(0), burnAmt); // comments for burning transfer 
        _transferStandard(sender, DevelopmentAddress, fundingPiece.mul(3));
        _transferStandard(sender, MarketingAddress, fundingPiece.mul(2));
        _transferStandard(sender, MiningAddress, fundingPiece.mul(2));
    ...
    function setMarketingWallet(address newWallet) external onlyOwner() {
     ...
     function setMiningWallet(address newWallet) external onlyOwner() {
        emit FeeEvent(newWallet); 
        MiningAddress = newWallet;
    }  
