...
contract EmpaFeeToken is ERC20, Ownable {
    ...
    constructor() ERC20("EmpaFeeWallet", "EPF") {
        ...
        uint256 _buyEmpaFee = 50;  //0.05%
        uint256 _buySaveTheChildrenFee = 2475;  //2.475%
        uint256 _buyLiquidityFee = 0;
        uint256 _buyDoctorsWithoutBorders = 2475; //2.475%
        
        uint256 _sellEmpaFee = 50; //0.05%
        uint256 _sellSaveTheChildrenFee = 2475; //2.475%
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDoctorsWithoutBorders = 2475; //2.475%
        ...
        if(takeFee){
            ...
            if (
                ...
                //when sell
                    ...
                    require((amount -= fees) + balanceOf(to) <= maxWallet, "Max wallet exceeded");
                }
            }
