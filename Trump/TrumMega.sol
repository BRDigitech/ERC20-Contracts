...
contract TRUMP is Context, Ownable, IERC20, ERC20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0xFE39aA26b482aBD68fae36651541a8f8bA8139CD);
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
   

    uint256 public numTokensSellToAddToLiquidity = 1000000 * 10**18;
    uint256 public maxTxAmount =   47000000000 * 10**18;
    ...
    constructor () ERC20Detailed("TRUMP", "MAGA TOKEN", 18) {
      _owner = msg.sender ;
    _totalSupply = 47000000000 * (10**18); 
