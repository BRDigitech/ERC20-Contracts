...
contract Kindcoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Kindcoin", "$KIND") {
    	...
    	marketingWallet = address(0x33A2620E9eCbCBC9B3A9Fe951f5D34F46182C94d); // set as marketing wallet
    	devWallet = address(0x33A2620E9eCbCBC9B3A9Fe951f5D34F46182C94d); // set as dev wallet
